...
@Autonomous(name = "AutoBluWaffle2", group = "Sample")
public class AutoBluWaffle2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        waffleup();
        driveBackwardE(1.0, 100);
        moveRghtE(1.0, 450);
        driveBackwardE(0.6, 1160);
        driveBackwardE(0.4, 200);
        waffledown();
